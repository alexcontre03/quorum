...
class TaskProposalAgent:
    ...
    def run(self, transcript: MeetingTranscript, definition: AgentDefinition) -> tuple[list[DetectedItem], AgentRun]:
    ...
    def _build_user_prompt(self, transcript: MeetingTranscript) -> str:
        return "\n".join(
            [
